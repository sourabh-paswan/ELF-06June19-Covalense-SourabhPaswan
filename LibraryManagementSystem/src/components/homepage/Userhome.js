          ...
          <div className="container">
            <div className="row row1">
              <ul className="largenav pull-right">
                ...
                <li className="upper-links"><a className="links" href="http://clashhacks.in/">request a book</a></li>
            ...
            <div className="row row2">
              ...
              <div className="flipkart-navbar-search smallsearch col-sm-8 col-xs-11">
                <div className="row">
                  <input className="flipkart-navbar-input col-xs-11" type placeholder="Search for books" name />
